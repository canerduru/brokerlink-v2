-- PORTFÖY EŞLEŞMESİ: Senin Portföyün + Mert Yılmaz'ın Talebi
-- Supabase SQL Editor'da çalıştır

-- ADIM 1: Mert Yılmaz için bir talep oluştur
INSERT INTO demands (
    user_id,
    title,
    category,
...
VALUES (
    ...
    'Beşiktaş''ta Lüks Daire Arıyorum',
    'Daire',
    'Satılık',
    40000000,
    60000000,
...
-- ADIM 2: Senin portföylerini listele
SELECT 
    p.id,
    p.title,
    p.category,
...
VALUES (
    (SELECT id FROM demands WHERE title = 'Beşiktaş''ta Lüks Daire Arıyorum' ORDER BY created_at DESC LIMIT 1),
...
WHERE d.title = 'Beşiktaş''ta Lüks Daire Arıyorum'
